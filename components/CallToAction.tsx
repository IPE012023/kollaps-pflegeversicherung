...
export default function CallToActionQuote() {
  return (
    <div className="my-12 bg-gray-50 p-10 rounded-lg shadow-lg container mx-auto flex flex-col md:flex-row items-center md:items-start gap-8 border border-gray-200 max-w-full">
      {/* Image container */}
      ...
      <div className="text-center md:text-left flex-grow">
        <blockquote className="text-xl md:text-2xl font-semibold italic text-gray-900 leading-relaxed">
        ...
        <p className="mt-6 text-lg font-medium text-gray-800">– Dr. Philipp Mauch, <span className='italic'>Managing Partner bei Pivot Regulatory und Werther GmbH</span></p>
      </div>
    </div>
  );
}
